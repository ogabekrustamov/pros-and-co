    ...
    <div className="flex flex-col bg-[#f7f6f3] text-[#1a1a1a]">
      ...
      <section className="flex relative w-full flex-col px-12 py-20 gap-7">
        ...
        <div className="flex flex-col gap-4">
          <HeroLine delay={0.05}>
            <p className="text-[#1a1a1aa6] text-[28px] italic leading-normal">{m.subtitle}</p>
          </HeroLine>
          <div className="flex flex-col font-['Oswald'] font-medium leading-[0.88] uppercase overflow-hidden">
            <RevealLine delay={0.1}><span className="text-[clamp(80px,16vw,220px)] tracking-[-5.5px] block">{m.line1}</span></RevealLine>
            <RevealLine delay={0.22}><span className="text-[clamp(80px,16vw,220px)] tracking-[-5.5px] block">{m.line2}</span></RevealLine>
            <RevealLine delay={0.34}><span className="text-[#2563eb] text-[clamp(80px,16vw,220px)] tracking-[-5.5px] block">{m.line3}</span></RevealLine>
          </div>
        </div>

        <FadeIn delay={0.5} className="flex justify-between items-end pt-10 mt-4 border-t gap-12 border-t-[#1a1a1a33]">
          <div className="flex items-center gap-5">
            <div className="size-14 bg-cover bg-no-repeat grayscale"
      ...
      <section className="flex w-full border-t px-12 py-24 gap-20 border-t-[#1a1a1a33]">
        <div className="flex max-w-[820px] flex-col flex-1 gap-7">
          ...
          <FadeIn delay={0.05} className="flex items-start gap-5">
            <span className="shrink-0 font-['Oswald'] text-[180px] leading-[0.78] tracking-[-7.2px] uppercase">{m.s01drop}</span>
            <p className="pt-2 text-[#1a1a1a] text-xl leading-[1.55]">{m.s01body1}</p>
          </FadeIn>
          <FadeIn delay={0.1}>
            <p className="text-[#1a1a1ae6] text-lg leading-[1.65]">{m.s01body2}</p>
          </FadeIn>
          <FadeIn delay={0.15}>
          ...
          <FadeIn delay={0.2}>
            <p className="text-[#1a1a1ae6] text-lg leading-[1.65]">{m.s02body}</p>
          </FadeIn>
        </div>
      ...
      <section className="flex w-full flex-col bg-[#1a1a1a] text-[#f7f6f3] px-12 py-[112px] gap-12">
        <FadeIn className="flex justify-between items-end pb-7 border-b gap-12 border-b-[#f7f6f333]">
          <div className="flex flex-col gap-3.5">
            ...
            <span className="font-['Oswald'] text-[clamp(48px,8vw,112px)] leading-[0.92] tracking-[-2.24px] uppercase">{m.s02headline}</span>
          </div>
          <p className="max-w-[320px] pb-4 text-[#f7f6f3a6] text-base italic">{m.s02sub}</p>
        </FadeIn>
      ...
      <section className="flex w-full px-12 py-[112px] gap-16">
        <FadeIn className="flex flex-col flex-1 gap-5">
          ...
          <span className="font-['Oswald'] text-8xl leading-[0.92] tracking-[-1.92px] uppercase">{m.s03headline}</span>
          <p className="max-w-[500px] mt-2 text-[#1a1a1acc] text-lg leading-[1.6]">{m.s03sub}</p>
        </FadeIn>
      ...
      <section className="flex w-full flex-col border-t px-12 py-[128px] gap-10 border-t-[#1a1a1a33]">
        ...
        <FadeIn delay={0.35} className="flex justify-between items-end gap-12">
          <div className="flex max-w-[640px] flex-col gap-[18px]">
            <p className="text-[#1a1a1ad9] text-[19px] leading-[1.6]">{m.closingBody}</p>
          ...
          <div className="flex flex-col items-end gap-2">
            <span className="text-[44px] italic leading-none">{m.closingAuthor}</span>
